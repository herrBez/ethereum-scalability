...
they are included can be discarded in favour of other blocks.
This uncertainty in the acceptance of a block is also known as
\textbf{lack of Consensus Finality}~\cite{bib:the-quest} due to the
PoW consensus algorithm.
In Bitcoin the 
confirmation number is 6 blocks~\cite that corresponds roughly to an hour~\cite{}.

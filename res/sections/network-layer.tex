...
\textbf{RLPx Node Discovery Protocol}~\cite{bib:rlpx-discovery-protocol}.
...
that all the nodes in the lists fail at the same time and to minimize memory
requirements and the send of messages, that will be dropped.
...
should reply with the contact information of the $k$ closest peers, it knows.

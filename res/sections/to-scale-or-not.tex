...
systems for which a high number of transactions can be built with Ethereum is
expected. Following this aim, one typical example is the case of Visa. Visa is

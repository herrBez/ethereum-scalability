...
for the devp2p protocol. The payload of the packets is encoded with the
Recursive Length Prefix Protocol
(\textbf{RLP})~\cite{wood2018ethereum,bib:ethereumrlpspec}.

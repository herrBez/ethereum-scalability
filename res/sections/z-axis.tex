...
\subparagraph{Plasma}
The idea of \textbf{Plasma} is to create a tree hierarchy of blockchains. Each
chain refers to a parent chain, except the root (i.e. the main chain, Ethereum
in our case). Plasma consists of a series of smart contracts which allows for
many blockchains within a root blockchain~\cite{poon2017plasma} as represented
...
\begin{figure}[!h]
  \begin{center}
    ...
    \captionsource{Plasma hierarchical tree structure representation.}{https://plasma.io/plasma.pdf}
    \label{fig:plasma}
  \end{center}
\end{figure}

...
reported also the coefficient of variation to show that the value of the last
...
platform\footnote{https://www.scaleway.com/}. We rent $17$ (one master
...
server run Ubuntu 16.04 and has installed, \texttt{geth} version 1.8.11-stable.
During the tests the master act also as bootstrap node. We described its role in
\autoref{sec:network-layer}.
...
tests~\footnote{https://github.com/gfornari/ethereum-test/tree/benchmark}.

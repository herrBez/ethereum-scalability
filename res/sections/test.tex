...
In \autoref{listing:genesis} we show an extract of the genesis block we used. 
...
block, the extra data, and the block number/hash corresponding to the
Ethereum Improvement Proposals, which indicate incompatible changes in the
protocols, other parameters used in the tests require some justification, that 
we provide in the remainder of this paragraph.

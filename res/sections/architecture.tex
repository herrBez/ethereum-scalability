...
by the OSI reference model. The model is comprised of 1 vertical layer
and 5 horizontal layers:
...
Sometimes we could refer to some implementation details along the description
of the layers, because the official documentations are not always complete,
especially those parts regarding the network and propagation layer. In this case
we take as reference implementation,
go-ethereum\footnote{\url{https://geth.ethereum.org/}}
(\texttt{geth}), which is maintained directly by the Ethereum Foundation.

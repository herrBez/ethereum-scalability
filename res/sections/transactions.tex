...
Ethereum} or to trigger contract code. A transaction represents (i.e. results)
a message call or the creation of a new account with associated EVM Code.
...
As we just mentioned it, a transaction and a message have the same structure
